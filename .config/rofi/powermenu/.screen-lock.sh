...
i3lock -n -i "$lock_image" -e --indicator --radius=20 --ring-width=40 \
  ...
  --bshl-color=$verify --time-str="%H:%M" --time-size=140 \
  ...
  --ind-pos="650:760" --time-font="Fira Code:style=Bold" \
  --date-font="Fira Code" --verif-font="Fira Code" --greeter-font="Fira Code" \
  --wrong-font="Fira Code" --verif-size=23 --greeter-size=23 --wrong-size=23 \
  --time-pos="650:540" --date-pos="650:600" --greeter-pos="650:930" \
  --wrong-pos="650:970" --verif-pos="650:805" --date-color=$date \
  --time-color=$date --greeter-color=$fg --wrong-color=$wrong \
  --verif-color=$verify --pointer=default --refresh-rate=0 \

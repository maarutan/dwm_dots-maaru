...
HOME = os.getenv("HOME")
ROFI_CONFIG = f"{HOME}/.suckless/scripts/wallpapers/images/.types/types.rasi"

GALLERY = f"{HOME}/.suckless/scripts/wallpapers/images/.types/.gallery.rasi"
ROW = f"{HOME}/.suckless/scripts/wallpapers/images/.types/.row.rasi"
ASSETS = f"{HOME}/.suckless/scripts/wallpapers/assets/types/"
RESULT = f"{HOME}/.suckless/scripts/wallpapers/images/.wall.rasi"
